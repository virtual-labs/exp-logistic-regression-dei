...
function showCompletionMessage() {
  ...
  const msgHTML = `
    ...
    <div style="text-align: center; animation: fadeIn 1s ease;">
      ...
      <p style="font-size: 1.2rem; color: #333; max-width: 600px; margin: 0 auto;">You have successfully completed the Logistic Regression experiment. You now understand how Logistic Regression is used for binary classification.</p>
